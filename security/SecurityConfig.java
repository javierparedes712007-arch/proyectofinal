...
/**
 * Configuración principal de seguridad REST/JWT.
 *
 * <p>Las rutas REST se protegen con JWT y roles. Las rutas SOAP se dejan pasar
 * a nivel HTTP para que la validación real se realice dentro del endpoint SOAP
 * mediante JAAS, usando usuario y contraseña enviados en el XML.</p>
 */

/**
 * Documentación JavaDoc de la clase SecurityConfig.
 *
 ...
 *
 * <p>Paquete/archivo: org.example.security.SecurityConfig.java</p>
 *
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/ws/**", "/soap/**", "/services/**").permitAll()
